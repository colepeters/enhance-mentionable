  ...
  return html`
    ...
    <main class='p4 m-auto'>
      <article class="h-entry mb3">
        <h1 class="p-name text3 font-semibold tracking-1 mb0">Enhance Mentionable 💬</h1>
        <h2 class="h2-summary text1 tracking-1 font-semibold mb3">A simple way to add mentions to your Enhance website.</h2>
        ...
        <div class="content">
          ...
          <p>Finally, a link to <a href="https://tbeseda.com/articles/2023/01/webmention-test" target="_blank">Taylor’s site</a> that accepts webmentions.</p>
        </div>
      </article>
